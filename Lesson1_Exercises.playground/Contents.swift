...
let index3 = Int(arc4random() % 9)
let index4 = Int(arc4random() % 9)
let yourSentence = "A \(nounArray[6]) loves his mac \(nounArray[1])"
let yourSillySentence = "A random sentance with \(nounArray[index3]) and \(nounArray[index4])"
//: ### Exercise 2
...
let shoutString2 = "HEY! " + didYouKnowString.uppercaseString
//: ### Exercise 3
...
for char in gString.lowercaseString.characters {
    if char == "g" {
        count+=1
    }
}
...
let word = "fortunate"
let substr = "tuna"
var output = word.containsString(substr) ? "\'\(word)\' contains \'\(substr) \'" : "\'\(word)\' do not contains \'\(substr) \'"
//: ### Exercise 6
//: Write a program that deletes all occurrences of the word "like" in the following string.
let lottaLikes = "If like, you wanna learn Swift, like, you should build lots of small apps, cuz it's like, a good way to practice."
lottaLikes.stringByReplacingOccurrencesOfString("like", withString:"")
//: ### Exercise 7
// Example
...
for (keyword, value) in dictionary {
    newestString = newestString.stringByReplacingOccurrencesOfString(keyword, withString: value)
}
newestString
//: ### Exercise 8
...
//desired output = "$5.67"
"$\(numOfPennies/100).\(numOfPennies%100)"
//: # Let or Var?
import UIKit
import Foundation
//: ### Exercise 9
...
let maximumTimeAllowed : timeval
var timeRemaining : timeval
