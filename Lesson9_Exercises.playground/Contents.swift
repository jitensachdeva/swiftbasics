...
let reverseSortedSurnames = surnames.sort({$1<$0})
reverseSortedSurnames
...
let reverseSortedAverages = battingAverages.sort({$1<$0 })
reverseSortedAverages
//: __Problem 3__
//:
...
let particleSizesInMicronsBelow20 = particleSizesInMicrons.filter({ $0 < 20})
particleSizesInMicronsBelow20
//: __Problem 5__
//:
...
let pricesInDollars = pricesInRupees.map({ "$\($0/45)" })
pricesInDollars
//: __Problem 6__
//:
