...
var bool_array = [true, false, false, true, false]
...
spaniels.insert("English Cocker", atIndex: spaniels.indexOf("English Springer")!)
//: ### Exercise 5
...
admitted.append(waitingList.removeFirst())
admitted.append(waitingList.removeFirst())
admitted
waitingList
...
var foo = ["Anchovies": true, "Coconut":false, "Cilantro":false, "Liver":false]
...
presidentialPetsDict.removeValueForKey("George Bush")
presidentialPetsDict
//: ### Exercise 11
